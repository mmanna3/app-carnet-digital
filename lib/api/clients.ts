...
export class Client {
    ...
    protected processInfoInicialDeTorneos(response: Response): Promise<InformacionInicialAgrupadorDTO[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    arbitroAsignacionPorAgrupador(agrupadorId: number | undefined, anio: number | undefined): Promise<AsignacionArbitrosPorAgrupadorDTO> {
    ...
    protected processArbitroAsignacionPorAgrupador(response: Response): Promise<AsignacionArbitrosPorAgrupadorDTO> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    asignarArbitrosJornada(jornadaId: number, body: AsignarArbitrosJornadaDTO | undefined): Promise<void> {
    ...
    marcarWhatsappEnviadoArbitroJornada(jornadaId: number, arbitroId: number): Promise<void> {
        let url_ = this.baseUrl + "/api/Arbitro/jornada/{jornadaId}/arbitros/{arbitroId}/whatsapp-enviado";
        if (jornadaId === undefined || jornadaId === null)
            throw new Error("The parameter 'jornadaId' must be defined.");
        url_ = url_.replace("{jornadaId}", encodeURIComponent("" + jornadaId));
    ...
    protected processJugadoresQueSoloJueganEnEsteEquipo(response: Response): Promise<JugadorBaseDTO[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processFasesAll(response: Response): Promise<FaseDTO[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(FaseDTO.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return OK
     */
    fasesCambiarVisibilidadEnApp(padreId: number, id: number, body: CambiarVisibilidadEnAppDTO | undefined): Promise<void> {
     ...
     * @return OK
     */
    categoriasPOST(torneoId: number, faseIdQuery: number | undefined, nombre: string, anioDesde: number, anioHasta: number, orden: number, faseIdPath: number, id: number | undefined): Promise<FaseCategoriaDTO> {
        let url_ = this.baseUrl + "/api/Torneo/{torneoId}/fases/{faseId}/categorias?";
        if (torneoId === undefined || torneoId === null)
            throw new Error("The parameter 'torneoId' must be defined.");
        url_ = url_.replace("{torneoId}", encodeURIComponent("" + torneoId));
     ...
     * @return OK
     */
    categoriasPUT(torneoId: number, faseIdQuery: number | undefined, idQuery: number | undefined, nombre: string, anioDesde: number, anioHasta: number, orden: number, faseIdPath: number, idPath: number): Promise<FaseCategoriaDTO> {
        let url_ = this.baseUrl + "/api/Torneo/{torneoId}/fases/{faseId}/categorias/{id}?";
        if (torneoId === undefined || torneoId === null)
            throw new Error("The parameter 'torneoId' must be defined.");
        url_ = url_.replace("{torneoId}", encodeURIComponent("" + torneoId));
     ...
     * @return OK
     */
    crearFechasTodoscontratodosMasivamente(padreId: number, body: FechaTodosContraTodosDTO[] | undefined): Promise<FechaTodosContraTodosDTO[]> {
    ...
    protected processCrearFechasTodoscontratodosMasivamente(response: Response): Promise<FechaTodosContraTodosDTO[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    crearFechasEliminaciondirectaMasivamente(padreId: number, body: FechaEliminacionDirectaDTO | undefined): Promise<FechaEliminacionDirectaDTO> {
        let url_ = this.baseUrl + "/api/Zona/{padreId}/fechas/crear-fechas-eliminaciondirecta-masivamente";
        if (padreId === undefined || padreId === null)
            throw new Error("The parameter 'padreId' must be defined.");
        url_ = url_.replace("{padreId}", encodeURIComponent("" + padreId));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCrearFechasEliminaciondirectaMasivamente(response: Response): Promise<FechaEliminacionDirectaDTO> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    borrarFechasEliminaciondirectaMasivamente(padreId: number): Promise<void> {
        let url_ = this.baseUrl + "/api/Zona/{padreId}/fechas/borrar-fechas-eliminaciondirecta-masivamente";
        if (padreId === undefined || padreId === null)
            throw new Error("The parameter 'padreId' must be defined.");
        url_ = url_.replace("{padreId}", encodeURIComponent("" + padreId));
        url_ = url_.replace(/[?&]$/, "");
    ...
    borrarFechasTodoscontratodosMasivamente(padreId: number): Promise<void> {
        let url_ = this.baseUrl + "/api/Zona/{padreId}/fechas/borrar-fechas-todoscontratodos-masivamente";
        if (padreId === undefined || padreId === null)
            throw new Error("The parameter 'padreId' must be defined.");
        url_ = url_.replace("{padreId}", encodeURIComponent("" + padreId));
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    cargarResultados(padreId: number, jornadaId: number, body: CargarResultadosDTO | undefined): Promise<void> {
     ...
     * @return OK
     */
    fechasCambiarVisibilidadEnApp(padreId: number, id: number, body: CambiarVisibilidadEnAppDTO | undefined): Promise<void> {
    ...
    protected processFechasAll(response: Response): Promise<FechaDTO[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(FechaDTO.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return OK
     */
    torneoCambiarVisibilidadEnApp(id: number, body: CambiarVisibilidadEnAppDTO | undefined): Promise<void> {
     ...
     * @return OK
     */
    categoriasPOST2(padreId: number, body: TorneoCategoriaDTO | undefined): Promise<TorneoCategoriaDTO> {
        let url_ = this.baseUrl + "/api/Torneo/{padreId}/categorias";
        if (padreId === undefined || padreId === null)
            throw new Error("The parameter 'padreId' must be defined.");
        url_ = url_.replace("{padreId}", encodeURIComponent("" + padreId));
    ...
    protected processCrearZonasMasivamente(response: Response): Promise<ZonaDTO[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(ZonaDTO.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
export class AsignarArbitrosJornadaDTO implements IAsignarArbitrosJornadaDTO {
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["arbitroIds"])) {
                ...
                for (let item of _data["arbitroIds"])
                    this.arbitroIds!.push(item);
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.arbitroIds)) {
            data["arbitroIds"] = [];
            for (let item of this.arbitroIds)
                data["arbitroIds"].push(item);
        }
        return data;
    }
}
...
export class CrearTorneoDTO implements ICrearTorneoDTO {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["fases"])) {
                ...
                for (let item of _data["fases"])
                    this.fases!.push(FaseDTO.fromJS(item));
            }
            ...
            this.primeraFase = _data["primeraFase"] ? FaseDTO.fromJS(_data["primeraFase"]) : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.fases)) {
            data["fases"] = [];
            for (let item of this.fases)
                data["fases"].push(item.toJSON());
        }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.elementos)) {
            ...
            for (let item of this.elementos)
                data["elementos"].push(item.toJSON());
        }
        return data;
    }
}
...
export class ReordenarFasesDTO implements IReordenarFasesDTO {
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["faseIds"])) {
                this.faseIds = [] as any;
                for (let item of _data["faseIds"])
                    this.faseIds!.push(item);
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.faseIds)) {
            data["faseIds"] = [];
            for (let item of this.faseIds)
                data["faseIds"].push(item);
        }
        return data;
    }
}
...
export class ZonaAsignacionDTO implements IZonaAsignacionDTO {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.nombre = _data["nombre"];
            this.proximaFecha = _data["proximaFecha"] ? ProximaFechaAsignacionDTO.fromJS(_data["proximaFecha"]) : <any>undefined;
        }
    }
