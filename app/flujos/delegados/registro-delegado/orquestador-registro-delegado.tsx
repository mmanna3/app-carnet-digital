...
import PantallaIntroDelegadoRegistro from '@/app/flujos/delegados/registro-delegado/components/pantalla-intro'
import PasoCodigoClub from '@/app/flujos/delegados/registro-delegado/components/paso-codigo-club'
import PasoDatosDelegado from '@/app/flujos/delegados/fichaje-delegado-nuevo/paso-datos-delegado'
import PasoFotoDelegado from '@/app/flujos/delegados/fichaje-delegado-nuevo/paso-foto-delegado'
import PasoFotosDniDelegado from '@/app/flujos/delegados/fichaje-delegado-nuevo/paso-fotos-dni-delegado'
import PasoConfirmacionDelegado from '@/app/flujos/delegados/fichaje-delegado-nuevo/paso-confirmacion-delegado'
import PasoDniDelegado from '@/app/flujos/delegados/fichaje-delegado-existente/paso-dni-delegado'
import PasoConfirmacionYaRegistrado from '@/app/flujos/delegados/fichaje-delegado-existente/paso-confirmacion-ya-registrado'
import PantallaCompletado from '@/app/flujos/delegados/registro-delegado/components/pantalla-completado'
