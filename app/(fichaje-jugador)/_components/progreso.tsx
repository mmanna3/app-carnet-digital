...
export default function Progreso() {
  ...
  return (
    <View
      className={`${esDelegado && 'pt-4'} flex-row items-center justify-center border-b border-border-glass bg-surface px-6 pb-6 pt-1`}
    >
        ...
        <View key={paso} className="flex-row items-center">
          ...
          {index < totalPasos - 1 && (
            <View
              className="h-0.5 w-6"
              style={{
                backgroundColor: paso < pasoActual ? temaVerde.bordeIcono : 'rgba(255, 255, 255, 0.08)',
              }}
            />
          )}
        </View>
