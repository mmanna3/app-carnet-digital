...
export class Client {
  ...
  carnets(equipoId: number | undefined): Promise<CarnetDigitalDTO[]> {
    ...
    if (equipoId === null) throw new Error("The parameter 'equipoId' cannot be null.")
    else if (equipoId !== undefined) url_ += 'equipoId=' + encodeURIComponent('' + equipoId) + '&'
    url_ = url_.replace(/[?&]$/, '')
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(CarnetDigitalDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  protected processJugadoresPendientes(response: Response): Promise<CarnetDigitalPendienteDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(CarnetDigitalPendienteDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  clubes(zonaId: number | undefined): Promise<ClubesDTO[]> {
    ...
    if (zonaId === null) throw new Error("The parameter 'zonaId' cannot be null.")
    else if (zonaId !== undefined) url_ += 'zonaId=' + encodeURIComponent('' + zonaId) + '&'
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processClubes(response: Response): Promise<ClubesDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(ClubesDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  protected processArbitrosPorIds(response: Response): Promise<ArbitroDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(ArbitroDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  arbitroAsignacionPorAgrupador(
    ...
    if (agrupadorId === null) throw new Error("The parameter 'agrupadorId' cannot be null.")
    ...
    else if (anio !== undefined) url_ += 'anio=' + encodeURIComponent('' + anio) + '&'
    url_ = url_.replace(/[?&]$/, '')
   ...
   * @return OK
   */
  marcarWhatsappEnviadoArbitroJornada(jornadaId: number, arbitroId: number): Promise<void> {
    let url_ =
      this.baseUrl + '/api/Arbitro/jornada/{jornadaId}/arbitros/{arbitroId}/whatsapp-enviado'
    if (jornadaId === undefined || jornadaId === null)
      throw new Error("The parameter 'jornadaId' must be defined.")
    url_ = url_.replace('{jornadaId}', encodeURIComponent('' + jornadaId))
  ...
  protected processMarcarWhatsappEnviadoArbitroJornada(response: Response): Promise<void> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  protected processGuardarBackupImagenesEnDisco(response: Response): Promise<void> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  protected processSubirBackupImagenesADrive(response: Response): Promise<void> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  protected processRestaurarImagenesDesdeBackup(response: Response): Promise<void> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  cambiarEscudo(id: number, body: CambiarEscudoDTO | undefined): Promise<number> {
  ...
  protected processConfiguracionesPorIds(response: Response): Promise<ConfiguracionDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(ConfiguracionDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  protected processDelegadosPorIds(response: Response): Promise<DelegadoDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(DelegadoDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
   ...
   * @return OK
   */
  aprobarDelegadoEnElClub(body: AprobarDelegadoEnElClubDTO | undefined): Promise<number> {
  ...
  protected processAprobarDelegadoEnElClub(response: Response): Promise<number> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  listarDelegadosConFiltro(estados: EstadoDelegadoEnum[] | undefined): Promise<DelegadoDTO[]> {
    let url_ = this.baseUrl + '/api/Delegado/listar-delegados-con-filtro?'
    if (estados === null) throw new Error("The parameter 'estados' cannot be null.")
  ...
  protected processListarDelegadosConFiltro(response: Response): Promise<DelegadoDTO[]> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  protected processDnisExpulsadosDeLaLigaPorIds(
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(DniExpulsadoDeLaLigaDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  protected processEquiposPorIds(response: Response): Promise<EquipoDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(EquipoDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  jugadoresQueSoloJueganEnEsteEquipo(id: number): Promise<JugadorBaseDTO[]> {
    let url_ = this.baseUrl + '/api/Equipo/{id}/jugadores-que-solo-juegan-en-este-equipo'
    if (id === undefined || id === null) throw new Error("The parameter 'id' must be defined.")
    url_ = url_.replace('{id}', encodeURIComponent('' + id))
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processJugadoresQueSoloJueganEnEsteEquipo(
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(JugadorBaseDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  protected processEquiposParaZonas(response: Response): Promise<EquipoParaZonasDTO[]> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(EquipoParaZonasDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
   ...
   * @return OK
   */
  fasesReordenar(padreId: number, body: ReordenarFasesDTO | undefined): Promise<void> {
  ...
  fasesCambiarVisibilidadEnApp(
    ...
    let url_ = this.baseUrl + '/api/Torneo/{padreId}/fases/{id}/visibilidad-en-app'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
    if (id === undefined || id === null) throw new Error("The parameter 'id' must be defined.")
  ...
  protected processFasesCambiarVisibilidadEnApp(response: Response): Promise<void> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  fasesPUT(padreId: number, id: number, body: FaseDTO | undefined): Promise<void> {
    let url_ = this.baseUrl + '/api/Torneo/{padreId}/fases/{id}'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
  ...
  protected processCategoriasAll(response: Response): Promise<FaseCategoriaDTO[]> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(FaseCategoriaDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  categoriasPOST(
    ...
    if (faseIdQuery === null) throw new Error("The parameter 'faseIdQuery' cannot be null.")
    else if (faseIdQuery !== undefined)
      url_ += 'faseId=' + encodeURIComponent('' + faseIdQuery) + '&'
    if (nombre === undefined || nombre === null)
      throw new Error("The parameter 'nombre' must be defined and cannot be null.")
    else url_ += 'Nombre=' + encodeURIComponent('' + nombre) + '&'
    if (anioDesde === undefined || anioDesde === null)
      throw new Error("The parameter 'anioDesde' must be defined and cannot be null.")
    else url_ += 'AnioDesde=' + encodeURIComponent('' + anioDesde) + '&'
    if (anioHasta === undefined || anioHasta === null)
      throw new Error("The parameter 'anioHasta' must be defined and cannot be null.")
    else url_ += 'AnioHasta=' + encodeURIComponent('' + anioHasta) + '&'
    if (orden === undefined || orden === null)
      throw new Error("The parameter 'orden' must be defined and cannot be null.")
  ...
  protected processCategoriasPOST(response: Response): Promise<FaseCategoriaDTO> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  categoriasGET(torneoId: number, faseId: number, id: number): Promise<FaseCategoriaDTO> {
    let url_ = this.baseUrl + '/api/Torneo/{torneoId}/fases/{faseId}/categorias/{id}'
    if (torneoId === undefined || torneoId === null)
      throw new Error("The parameter 'torneoId' must be defined.")
    url_ = url_.replace('{torneoId}', encodeURIComponent('' + torneoId))
    if (faseId === undefined || faseId === null)
  ...
  protected processCategoriasGET(response: Response): Promise<FaseCategoriaDTO> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  categoriasPUT(
    ...
    if (faseIdQuery === null) throw new Error("The parameter 'faseIdQuery' cannot be null.")
      ...
      url_ += 'faseId=' + encodeURIComponent('' + faseIdQuery) + '&'
    if (idQuery === null) throw new Error("The parameter 'idQuery' cannot be null.")
    else if (idQuery !== undefined) url_ += 'id=' + encodeURIComponent('' + idQuery) + '&'
    if (nombre === undefined || nombre === null)
      throw new Error("The parameter 'nombre' must be defined and cannot be null.")
    else url_ += 'Nombre=' + encodeURIComponent('' + nombre) + '&'
    if (anioDesde === undefined || anioDesde === null)
  ...
  protected processCategoriasPUT(response: Response): Promise<FaseCategoriaDTO> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  categoriasDELETE(torneoId: number, faseId: number, id: number): Promise<void> {
    let url_ = this.baseUrl + '/api/Torneo/{torneoId}/fases/{faseId}/categorias/{id}'
    if (torneoId === undefined || torneoId === null)
      throw new Error("The parameter 'torneoId' must be defined.")
    url_ = url_.replace('{torneoId}', encodeURIComponent('' + torneoId))
  ...
  crearFechasTodoscontratodosMasivamente(
    ...
    let url_ = this.baseUrl + '/api/Zona/{padreId}/fechas/crear-fechas-todoscontratodos-masivamente'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processCrearFechasTodoscontratodosMasivamente(
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(FechaTodosContraTodosDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  crearFechasEliminaciondirectaMasivamente(
    ...
    let url_ =
      this.baseUrl + '/api/Zona/{padreId}/fechas/crear-fechas-eliminaciondirecta-masivamente'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
    url_ = url_.replace(/[?&]$/, '')
  ...
  borrarFechasEliminaciondirectaMasivamente(padreId: number): Promise<void> {
    let url_ =
      this.baseUrl + '/api/Zona/{padreId}/fechas/borrar-fechas-eliminaciondirecta-masivamente'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processBorrarFechasEliminaciondirectaMasivamente(response: Response): Promise<void> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  borrarFechasTodoscontratodosMasivamente(padreId: number): Promise<void> {
    let url_ =
      this.baseUrl + '/api/Zona/{padreId}/fechas/borrar-fechas-todoscontratodos-masivamente'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processBorrarFechasTodoscontratodosMasivamente(response: Response): Promise<void> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  modificarFechasMasivamente(padreId: number, body: FechaDTO[] | undefined): Promise<void> {
    let url_ = this.baseUrl + '/api/Zona/{padreId}/fechas/modificar-fechas-masivamente'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processModificarFechasMasivamente(response: Response): Promise<void> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  cargarResultados(
    ...
    let url_ = this.baseUrl + '/api/Zona/{padreId}/fechas/cargar-resultados/{jornadaId}'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
    if (jornadaId === undefined || jornadaId === null)
  ...
  fechasCambiarVisibilidadEnApp(
    ...
    let url_ = this.baseUrl + '/api/Zona/{padreId}/fechas/{id}/visibilidad-en-app'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
    if (id === undefined || id === null) throw new Error("The parameter 'id' must be defined.")
  ...
  protected processFechasCambiarVisibilidadEnApp(response: Response): Promise<void> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  fechasPUT(padreId: number, id: number, body: FechaDTO | undefined): Promise<void> {
    let url_ = this.baseUrl + '/api/Zona/{padreId}/fechas/{id}'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
   ...
   * @return OK
   */
  fixtureAlgoritmoPOST(body: FixtureAlgoritmoDTO | undefined): Promise<FixtureAlgoritmoDTO> {
  ...
  protected processFixtureAlgoritmoPOST(response: Response): Promise<FixtureAlgoritmoDTO> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  protected processFixtureAlgoritmoAll(response: Response): Promise<FixtureAlgoritmoDTO[]> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(FixtureAlgoritmoDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
   ...
   * @return OK
   */
  fixtureAlgoritmosPorIds(ids: number[] | undefined): Promise<FixtureAlgoritmoDTO[]> {
  ...
  protected processFixtureAlgoritmosPorIds(response: Response): Promise<FixtureAlgoritmoDTO[]> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  protected processFixtureAlgoritmoGET(response: Response): Promise<FixtureAlgoritmoDTO> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  fixtureAlgoritmoPUT(id: number, body: FixtureAlgoritmoDTO | undefined): Promise<void> {
    let url_ = this.baseUrl + '/api/FixtureAlgoritmo/{id}'
    if (id === undefined || id === null) throw new Error("The parameter 'id' must be defined.")
    url_ = url_.replace('{id}', encodeURIComponent('' + id))
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processGruposDeFasesAll(response: Response): Promise<GrupoDeFasesDTO[]> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(GrupoDeFasesDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
   ...
   * @return OK
   */
  gruposDeFasesPOST(padreId: number, body: GrupoDeFasesDTO | undefined): Promise<GrupoDeFasesDTO> {
    let url_ = this.baseUrl + '/api/Torneo/{padreId}/grupos-de-fases'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
  ...
  protected processGruposDeFasesPOST(response: Response): Promise<GrupoDeFasesDTO> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  protected processGruposDeFasesGET(response: Response): Promise<GrupoDeFasesDTO> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  gruposDeFasesPUT(padreId: number, id: number, body: GrupoDeFasesDTO | undefined): Promise<void> {
    let url_ = this.baseUrl + '/api/Torneo/{padreId}/grupos-de-fases/{id}'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
  ...
  protected processJugadoresPorIds(response: Response): Promise<JugadorDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(JugadorDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
   ...
   * @return OK
   */
  actualizarTarjetas(body: ActualizarTarjetasJugadorDTO | undefined): Promise<number> {
  ...
  elDniEstaFichado(dni: string | undefined): Promise<boolean> {
    ...
    else if (dni !== undefined) url_ += 'dni=' + encodeURIComponent('' + dni) + '&'
    url_ = url_.replace(/[?&]$/, '')
  ...
  obtenerNombreUsuarioDisponible(
    ...
    if (nombre === null) throw new Error("The parameter 'nombre' cannot be null.")
    else if (nombre !== undefined) url_ += 'nombre=' + encodeURIComponent('' + nombre) + '&'
    if (apellido === null) throw new Error("The parameter 'apellido' cannot be null.")
    else if (apellido !== undefined) url_ += 'apellido=' + encodeURIComponent('' + apellido) + '&'
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processEscudosClubes(response: Response): Promise<EscudoClubDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(EscudoClubDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  protected processSponsorsWebPublica(response: Response): Promise<SponsorWebPublicaPublicoDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(SponsorWebPublicaPublicoDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  obtenerReportePagos(
    ...
    else if (mes !== undefined) url_ += 'mes=' + encodeURIComponent('' + mes) + '&'
    if (anio === null) throw new Error("The parameter 'anio' cannot be null.")
    else if (anio !== undefined) url_ += 'anio=' + encodeURIComponent('' + anio) + '&'
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processObtenerReportePagos(response: Response): Promise<ReportePagosDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(ReportePagosDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  protected processSponsorWebPublicaAll(response: Response): Promise<SponsorWebPublicaDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(SponsorWebPublicaDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  protected processTorneosPorIds(response: Response): Promise<TorneoDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(TorneoDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
   ...
   * @return OK
   */
  torneosFiltrar(anio: number | undefined, agrupador: number | undefined): Promise<TorneoDTO[]> {
    let url_ = this.baseUrl + '/api/Torneo/filtrar?'
    if (anio === null) throw new Error("The parameter 'anio' cannot be null.")
    else if (anio !== undefined) url_ += 'anio=' + encodeURIComponent('' + anio) + '&'
    if (agrupador === null) throw new Error("The parameter 'agrupador' cannot be null.")
  ...
  protected processTorneoCambiarVisibilidadEnApp(response: Response): Promise<void> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  torneoPersistirEstructuraFases(id: number, body: EstructuraFasesDTO | undefined): Promise<void> {
  ...
  protected processTorneoPersistirEstructuraFases(response: Response): Promise<void> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  torneoAgrupadorPOST(body: TorneoAgrupadorDTO | undefined): Promise<TorneoAgrupadorDTO> {
  ...
  protected processTorneoAgrupadorPOST(response: Response): Promise<TorneoAgrupadorDTO> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  protected processTorneoAgrupadorAll(response: Response): Promise<TorneoAgrupadorDTO[]> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(TorneoAgrupadorDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
   ...
   * @return OK
   */
  torneoAgrupadoresPorIds(ids: number[] | undefined): Promise<TorneoAgrupadorDTO[]> {
  ...
  protected processTorneoAgrupadoresPorIds(response: Response): Promise<TorneoAgrupadorDTO[]> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  protected processTorneoAgrupadorGET(response: Response): Promise<TorneoAgrupadorDTO> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  torneoAgrupadorPUT(id: number, body: TorneoAgrupadorDTO | undefined): Promise<void> {
    let url_ = this.baseUrl + '/api/TorneoAgrupador/{id}'
    if (id === undefined || id === null) throw new Error("The parameter 'id' must be defined.")
    url_ = url_.replace('{id}', encodeURIComponent('' + id))
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processCategoriasAll2(response: Response): Promise<TorneoCategoriaDTO[]> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(TorneoCategoriaDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  protected processCategoriasPOST2(response: Response): Promise<TorneoCategoriaDTO> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
  ...
  protected processCategoriasGET2(response: Response): Promise<TorneoCategoriaDTO> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  categoriasPUT2(padreId: number, id: number, body: TorneoCategoriaDTO | undefined): Promise<void> {
    let url_ = this.baseUrl + '/api/Torneo/{padreId}/categorias/{id}'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
  ...
  protected processUsuarioAll(response: Response): Promise<UsuarioAdminDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(UsuarioAdminDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
   ...
   * @return OK
   */
  crearZonasMasivamente(padreId: number, body: ZonaDTO[] | undefined): Promise<ZonaDTO[]> {
    let url_ = this.baseUrl + '/api/Fase/{padreId}/zonas/crear-zonas-masivamente'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processCrearZonasMasivamente(response: Response): Promise<ZonaDTO[]> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  modificarZonasMasivamente(padreId: number, body: ZonaDTO[] | undefined): Promise<void> {
    let url_ = this.baseUrl + '/api/Fase/{padreId}/zonas/modificar-zonas-masivamente'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processModificarZonasMasivamente(response: Response): Promise<void> {
    const status = response.status
    let _headers: any = {}
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v))
   ...
   * @return OK
   */
  zonasPUT(padreId: number, id: number, body: ZonaDTO | undefined): Promise<void> {
    let url_ = this.baseUrl + '/api/Fase/{padreId}/zonas/{id}'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
  ...
  protected processLeyendasAll(response: Response): Promise<LeyendaTablaPosicionesDTO[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any
          for (let item of resultData200) result200!.push(LeyendaTablaPosicionesDTO.fromJS(item))
        } else {
          result200 = <any>null
        }
        return result200
  ...
  leyendasPOST(
    padreId: number,
    body: LeyendaTablaPosicionesDTO | undefined
  ): Promise<LeyendaTablaPosicionesDTO> {
    let url_ = this.baseUrl + '/api/Zona/{padreId}/leyendas'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
...
export class ArbitroConJornadasAsignacionDTO implements IArbitroConJornadasAsignacionDTO {
    ...
    if (_data) {
      ...
      if (Array.isArray(_data['jornadasProximaFecha'])) {
        ...
        for (let item of _data['jornadasProximaFecha'])
          this.jornadasProximaFecha!.push(JornadaAsignadaResumenDTO.fromJS(item))
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.jornadasProximaFecha)) {
      ...
      for (let item of this.jornadasProximaFecha) data['jornadasProximaFecha'].push(item.toJSON())
    }
    return data
  }
}
...
export class ArbitroDTO implements IArbitroDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['torneoAgrupadorIds'])) {
        ...
        for (let item of _data['torneoAgrupadorIds']) this.torneoAgrupadorIds!.push(item)
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.torneoAgrupadorIds)) {
      ...
      for (let item of this.torneoAgrupadorIds) data['torneoAgrupadorIds'].push(item)
    }
    if (Array.isArray(this.torneoAgrupadores)) {
      data['torneoAgrupadores'] = []
      for (let item of this.torneoAgrupadores) data['torneoAgrupadores'].push(item.toJSON())
    }
    return data
  }
}
    ...
    if (_data) {
      ...
      if (Array.isArray(_data['jornadasAsignadasEnProximasFechas'])) {
        ...
        for (let item of _data['jornadasAsignadasEnProximasFechas'])
          this.jornadasAsignadasEnProximasFechas!.push(JornadaAsignadaResumenDTO.fromJS(item))
      }
    }
  }
...
export class AsignacionArbitrosPorAgrupadorDTO implements IAsignacionArbitrosPorAgrupadorDTO {
    ...
    if (_data) {
      if (Array.isArray(_data['arbitrosElegibles'])) {
        ...
        for (let item of _data['arbitrosElegibles'])
          this.arbitrosElegibles!.push(ArbitroElegibleAsignacionDTO.fromJS(item))
      }
      if (Array.isArray(_data['torneos'])) {
        this.torneos = [] as any
        for (let item of _data['torneos']) this.torneos!.push(TorneoAsignacionDTO.fromJS(item))
      }
      if (Array.isArray(_data['arbitrosConJornadas'])) {
        this.arbitrosConJornadas = [] as any
        for (let item of _data['arbitrosConJornadas'])
          this.arbitrosConJornadas!.push(ArbitroConJornadasAsignacionDTO.fromJS(item))
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.arbitrosElegibles)) {
      ...
      for (let item of this.arbitrosElegibles) data['arbitrosElegibles'].push(item.toJSON())
    }
    ...
    if (Array.isArray(this.arbitrosConJornadas)) {
      ...
      for (let item of this.arbitrosConJornadas) data['arbitrosConJornadas'].push(item.toJSON())
    }
    return data
  }
}
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['partidos'])) {
        ...
        for (let item of _data['partidos']) this.partidos!.push(PartidoDTO.fromJS(item))
      }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['renglones'])) {
        ...
        for (let item of _data['renglones']) this.renglones!.push(PosicionDelEquipoDTO.fromJS(item))
      }
    }
  }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['equipos'])) {
        this.equipos = [] as any
        for (let item of _data['equipos']) this.equipos!.push(EquipoBaseDTO.fromJS(item))
      }
    }
  }
...
export class ClubDTO implements IClubDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['equipos'])) {
        this.equipos = [] as any
        for (let item of _data['equipos']) this.equipos!.push(EquipoDTO.fromJS(item))
      }
      if (Array.isArray(_data['delegados'])) {
        this.delegados = [] as any
        for (let item of _data['delegados']) this.delegados!.push(DelegadoDTO.fromJS(item))
      }
    }
  }
...
export class CrearTorneoDTO implements ICrearTorneoDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['categorias'])) {
        ...
        for (let item of _data['categorias']) this.categorias!.push(TorneoCategoriaDTO.fromJS(item))
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.gruposDeFases)) {
      data['gruposDeFases'] = []
      for (let item of this.gruposDeFases) data['gruposDeFases'].push(item.toJSON())
    }
    data['primeraFase'] = this.primeraFase ? this.primeraFase.toJSON() : <any>undefined
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['equiposDelClub'])) {
        ...
        for (let item of _data['equiposDelClub']) this.equiposDelClub!.push(item)
      }
    }
  }
...
export class DelegadoDTO implements IDelegadoDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.telefonoCelular = _data['telefonoCelular']
      this.email = _data['email']
      this.usuario = _data['usuario'] ? UsuarioDTO.fromJS(_data['usuario']) : <any>undefined
      this.fotoCarnet = _data['fotoCarnet']
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.delegadoClubs)) {
      data['delegadoClubs'] = []
      for (let item of this.delegadoClubs) data['delegadoClubs'].push(item.toJSON())
    }
    data['jugadorId'] = this.jugadorId
    return data
  }
...
export class EliminacionDirectaDTO implements IEliminacionDirectaDTO {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['instancias'])) {
        ...
        for (let item of _data['instancias']) this.instancias!.push(InstanciasDTO.fromJS(item))
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.instancias)) {
      data['instancias'] = []
      for (let item of this.instancias) data['instancias'].push(item.toJSON())
    }
    return data
  }
}
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['zonas'])) {
        this.zonas = [] as any
        for (let item of _data['zonas']) this.zonas!.push(ZonaResumenDTO.fromJS(item))
      }
      if (Array.isArray(_data['jugadores'])) {
        this.jugadores = [] as any
        for (let item of _data['jugadores']) this.jugadores!.push(JugadorDelEquipoDTO.fromJS(item))
      }
    }
  }
...
export class EquiposDelDelegadoDTO implements IEquiposDelDelegadoDTO {
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.clubsConEquipos)) {
      ...
      for (let item of this.clubsConEquipos) data['clubsConEquipos'].push(item.toJSON())
    }
    return data
  }
}
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['items'])) {
        this.items = [] as any
        for (let item of _data['items']) this.items!.push(EstructuraFasesItemDTO.fromJS(item))
      }
    }
  }
...
export class FaseAsignacionDTO implements IFaseAsignacionDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['zonas'])) {
        this.zonas = [] as any
        for (let item of _data['zonas']) this.zonas!.push(ZonaAsignacionDTO.fromJS(item))
      }
    }
  }
...
export class FaseDTO implements IFaseDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['zonas'])) {
        this.zonas = [] as any
        for (let item of _data['zonas']) this.zonas!.push(ZonaDeFaseDTO.fromJS(item))
      }
      if (Array.isArray(_data['categorias'])) {
        this.categorias = [] as any
        for (let item of _data['categorias']) this.categorias!.push(FaseCategoriaDTO.fromJS(item))
      }
    }
  }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['jornadas'])) {
        ...
        for (let item of _data['jornadas']) this.jornadas!.push(JornadaDTO.fromJS(item))
      }
    }
  }
...
export class FechasParaJornadasDTO implements IFechasParaJornadasDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['jornadas'])) {
        this.jornadas = [] as any
        for (let item of _data['jornadas']) this.jornadas!.push(JornadasPorFechaDTO.fromJS(item))
      }
    }
  }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['fechas'])) {
        this.fechas = [] as any
        for (let item of _data['fechas']) this.fechas!.push(FixtureAlgoritmoFechaDTO.fromJS(item))
      }
    }
  }
...
export class FixtureDTO implements IFixtureDTO {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['fechas'])) {
        this.fechas = [] as any
        for (let item of _data['fechas']) this.fechas!.push(FixtureFechaDTO.fromJS(item))
      }
    }
  }
...
export class FixtureFechaDTO implements IFixtureFechaDTO {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['partidos'])) {
        this.partidos = [] as any
        for (let item of _data['partidos']) this.partidos!.push(FixturePartidoDTO.fromJS(item))
      }
      this.titulo = _data['titulo']
      this.dia = _data['dia']
    }
...
export class InformacionInicialElementoTorneoDTO implements IInformacionInicialElementoTorneoDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['zonas'])) {
        this.zonas = [] as any
        for (let item of _data['zonas']) this.zonas!.push(InformacionInicialZonaDTO.fromJS(item))
      }
      this.grupoId = _data['grupoId']
...
export class JornadaAsignacionDTO implements IJornadaAsignacionDTO {
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.arbitrosAsignados)) {
      ...
      for (let item of this.arbitrosAsignados) data['arbitrosAsignados'].push(item.toJSON())
    }
    return data
  }
}
...
export class JornadasDTO implements IJornadasDTO {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['fechas'])) {
        this.fechas = [] as any
        for (let item of _data['fechas']) this.fechas!.push(FechasParaJornadasDTO.fromJS(item))
      }
    }
  }
...
export class JugadorDTO implements IJugadorDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['equipos'])) {
        this.equipos = [] as any
        for (let item of _data['equipos']) this.equipos!.push(EquipoDelJugadorDTO.fromJS(item))
      }
      this.fotoCarnet = _data['fotoCarnet']
      this.fotoDNIFrente = _data['fotoDNIFrente']
      this.fotoDNIDorso = _data['fotoDNIDorso']
...
export class JugadorDelEquipoDTO implements IJugadorDelEquipoDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.nombre = _data['nombre']
      this.apellido = _data['apellido']
      this.anioNacimiento = _data['anioNacimiento']
      this.estado = _data['estado']
      this.jugadorEquipoId = _data['jugadorEquipoId']
      this.motivo = _data['motivo']
      this.tarjetasAmarillas = _data['tarjetasAmarillas']
  ...
  toJSON(data?: any) {
    ...
    data['nombre'] = this.nombre
    data['apellido'] = this.apellido
    data['anioNacimiento'] = this.anioNacimiento
    data['estado'] = this.estado
    data['jugadorEquipoId'] = this.jugadorEquipoId
    data['motivo'] = this.motivo
    data['tarjetasAmarillas'] = this.tarjetasAmarillas
...
export class PlanillaDeJuegoDTO implements IPlanillaDeJuegoDTO {
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.planillas)) {
      data['planillas'] = []
      for (let item of this.planillas) data['planillas'].push(item.toJSON())
    }
    data['torneo'] = this.torneo
    data['equipo'] = this.equipo
    return data
...
export class ProximaFechaAsignacionDTO implements IProximaFechaAsignacionDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['jornadas'])) {
        this.jornadas = [] as any
        for (let item of _data['jornadas']) this.jornadas!.push(JornadaAsignacionDTO.fromJS(item))
      }
    }
  }
...
export class TorneoAgrupadorDTO implements ITorneoAgrupadorDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['torneos'])) {
        this.torneos = [] as any
        for (let item of _data['torneos']) this.torneos!.push(TorneoDTO.fromJS(item))
      }
    }
  }
...
export class TorneoAsignacionDTO implements ITorneoAsignacionDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['fases'])) {
        this.fases = [] as any
        for (let item of _data['fases']) this.fases!.push(FaseAsignacionDTO.fromJS(item))
      }
    }
  }
...
export class ZonaAsignacionDTO implements IZonaAsignacionDTO {
  ...
  toJSON(data?: any) {
    ...
    data['id'] = this.id
    data['nombre'] = this.nombre
    data['proximaFecha'] = this.proximaFecha ? this.proximaFecha.toJSON() : <any>undefined
    return data
  }
}
...
export class ZonaDTO implements IZonaDTO {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['equipos'])) {
        this.equipos = [] as any
        for (let item of _data['equipos']) this.equipos!.push(EquipoDeLaZonaDTO.fromJS(item))
      }
    }
  }
